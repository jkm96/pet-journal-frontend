...
export default function RenderPdfGridImages({imageBuffers}: {
    ...
    return (
        ...
        <View style={{flexDirection: 'row', flexWrap: 'wrap', marginTop: 3}}>
            ...
            {imageBuffers.length > 1 && (
                <View style={{
                    ...
                    {imageBuffers.map((image, index) => (
                        <View key={index} style={{width: '100%', marginTop: 2, padding: 5}}>
                            <Image
            ...
            {imageBuffers.length > 1 && imageBuffers.length <= 4 ? (
                <View style={{
                    flex: 1,
                    flexDirection: 'row',
                    flexWrap: 'wrap',
                    ...
                    {imageBuffers.map((image, index) => (
                        <View key={index} style={{width: '50%', marginTop: 2, padding: 5}}>
                            <Image
                                style={{height: 200, maxHeight: 200}}
                                src={`data:image/${image.imageType};base64,${image.imageBuffer}`}
                            />
                ...
                <View style={{
                    ...
                    <View style={{flex: 1, flexDirection: 'row', width: '50%', flexWrap: 'wrap',marginTop: 4, marginBottom: 0}}>
