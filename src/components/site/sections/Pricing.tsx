    ...
    <section className='bg-white dark:bg-gray-900' id='pricing'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
        <div className='mx-auto max-w-screen-md text-center mb-8 lg:mb-12'>
          <h2 className='mb-4 text-4xl tracking-tight font-extrabold text-black-2 dark:text-white'>Designed for pet
            lovers like you</h2>
          <p className='mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400'>Here at PetDiaries we focus on
            economical and affordable packages</p>
        </div>
        <div className='space-y-8 lg:grid lg:grid-cols-1 sm:gap-6 xl:gap-10 lg:space-y-0'>
          ...
          <div
            ...
            <p className='font-light text-gray-500 sm:text-lg dark:text-gray-400'>Billed monthly, extended & premium
              support.</p>
