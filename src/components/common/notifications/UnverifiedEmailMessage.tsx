...
export default function UnverifiedEmailMessage() {
  ...
  return (
    <>
      {userInfo && !userInfo.isAdmin && !userInfo.isGracePeriodExpired && (
        <div
          className='w-full grid p-2 place-items-center bg-yellow-100 dark:bg-boxdark dark:border-1 dark:border-gray'>
          <div
            className='flex items-center text-sm text-yellow-900 dark:text-yellow-400' role='alert'>
            ...
            <div>
              <span className='font-medium'>Email Verification Alert!</span> You have {userInfo.gracePeriodCount} days
